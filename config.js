export const CONFIG = {
  ...
  palette: [
    ...
    { name: "Light Blue", hex: "#9EABDF" },
    { name: "Light Pink", hex: "#FF74C5" },
    { name: "Light Cyan", hex: "#8DE6F4" },
    { name: "Light Green", hex: "#77ED8B" },
    { name: "Light Yellow", hex: "#FFD666" },
    { name: "Light Peach", hex: "#FFAC82" },
    { name: "Blue", hex: "#0037A6" },
    { name: "Pink", hex: "#BF0070" },
    { name: "Muted Cyan", hex: "#73BECA" },
    { name: "Green", hex: "#22C55E" },
    { name: "Amber", hex: "#FFAB00" },
    { name: "Red", hex: "#FF5630" },
    { name: "Navy", hex: "#00246D" },
    { name: "Dark Pink", hex: "#970059" },
    { name: "Teal", hex: "#348A98" },
    { name: "Dark Green", hex: "#118D57" },
    { name: "Dark Amber", hex: "#B76E00" },
    { name: "Dark Red", hex: "#B71D18" },
  ],
  textPalette: [
    { name: "Black", hex: "#000000" },
    { name: "White", hex: "#FFFFFF" },
